...
from Hardware.Class_Nozzles1 import Nozzles1
from Hardware.Class_Nozzles2 import Nozzles2
...
class Measurements:
    ...
    def __init__(self, stand='Stand Nr.1'):
        ...
        if self.stand == 'Stand Nr.2':
            self.nozzles = Nozzles2()
        else:
            self.nozzles = Nozzles1()
    ...
    def set_nozzle(self, key, value: bool):
        ...
        print(self.nozzles.open_nozzles)
