    ...
    def create_main_window(self):
        ...
        while True:
            ...
            if event in (sg.WIN_CLOSED, 'Exit'):
                ...
                measurements.set_nozzle('19.05', window['-19-'].get())
            elif event == '-25-':
                measurements.set_nozzle('25.4', window['-25-'].get())
            elif event == '-38-':
                measurements.set_nozzle('38.1', window['-38-'].get())
            elif event == '-50-':
                measurements.set_nozzle('50.8', window['-50-'].get())
            elif event == '-76-':
